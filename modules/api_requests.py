...
def fetch_toots(mastodon, limit = 40, max_id=None, min_id=None, since_id=None):
    try:
        ...
        logging.info(f"An error occurred with the request: {str(e)}. If error of a TypeError, ignore.")
    ...
    while True:
        ...
        for mastodon in mastodons:
            while True:
                ...
                logging.info(f"Last toot ID: {min_id}; Last toot timestamp: {time_stamp}")
